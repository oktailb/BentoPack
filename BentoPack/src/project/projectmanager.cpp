...
{
    QJsonObject root;
    root[QStringLiteral("format")] = QStringLiteral("BentoPackProject");
    root[QStringLiteral("version")] = QStringLiteral("1.0");
    root[QStringLiteral("generator")] = QStringLiteral("BentoPack");
                                              ...
                                              QString *errorMsg)
{
    ...
    if (format != QStringLiteral("BentoPackProject") && format != QStringLiteral("BentoPackProject")) {
