    ...
    : QDialog(parent)
{
  ...
  setWindowTitle(tr("KEY_DIALOG_ABOUT_TITLE") + QStringLiteral(" - Sprite Studio"));
...
void AboutDialog::changeEvent(QEvent *event)
{
    if (event->type() == QEvent::LanguageChange) {
        ...
        if (SpriteStudio::IntegrityGuard::isTampered()) {
            editionNoticeLabel->setText(tr("KEY_EDITION_NOTICE_TAMPERED"));
        } else if (SpriteStudio::LicenseManager::isCommercial()) {
...
void AboutDialog::setupUI()
{
  ...
  titleLabel = new QLabel(QStringLiteral("Sprite Studio"), this);
...
void AboutDialog::loadApplicationInfo()
{
  ...
  QString aboutHtml = QString(
      ...
      "    <h3 style='color: %2; margin-bottom: 6px;'>Sprite Studio</h3>"
      ...
      "    <div><b>GitHub :</b> <a style='color: #38bdf8;' href='https://github.com/oktailb/SpriteStudio'>https://github.com/oktailb/SpriteStudio</a></div>"
      "  </div>"
...
void AboutDialog::loadPricing()
{
  ...
  QString currentEdition = SpriteStudio::IntegrityGuard::isTampered()
      ? QStringLiteral("tampered")
      : (SpriteStudio::LicenseManager::isCommercial() ? QStringLiteral("gui_seat") : QStringLiteral("community"));
...
void AboutDialog::loadPluginsInfo()
{
  ...
  QString html = QStringLiteral(
      ...
      "    <b style='color: %2;'>%8</b> SpriteStudioCore (<code>libSpriteStudioCore.so / .dll</code>)<br>"
